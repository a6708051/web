...
<head>
  ...
  <title>Nothing found for  404</title>
		<style>
		body {background: #f3f3f3;margin: 0; padding: 20px; text-align:center; font-family:Arial, Helvetica, sans-serif; font-size:14px; color:#666666;}
...
<body class="login">
  <div class="error_page">
    ...
    <p><a href="http://lieshow.com">Return to the homepage</a></p>
  </div>
</body>
</html>